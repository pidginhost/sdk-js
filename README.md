...
```
npm install @pidginhost/sdk@0.10.0 --save
```
...
*CloudApi* | [**cloudFloatingIpv4AuthorizationsRetrieve**](docs/CloudApi.md#cloudfloatingipv4authorizationsretrieve) | **GET** /api/cloud/floating-ipv4/{id}/authorizations/ | 
...
*CloudApi* | [**cloudFloatingIpv4RdnsCreate**](docs/CloudApi.md#cloudfloatingipv4rdnscreate) | **POST** /api/cloud/floating-ipv4/{id}/rdns/ | 
*CloudApi* | [**cloudFloatingIpv4RdnsRetrieve**](docs/CloudApi.md#cloudfloatingipv4rdnsretrieve) | **GET** /api/cloud/floating-ipv4/{id}/rdns/ | 
...
*CloudApi* | [**cloudFloatingIpv6AuthorizationsRetrieve**](docs/CloudApi.md#cloudfloatingipv6authorizationsretrieve) | **GET** /api/cloud/floating-ipv6/{id}/authorizations/ | 
...
*CloudApi* | [**cloudFloatingIpv6RdnsCreate**](docs/CloudApi.md#cloudfloatingipv6rdnscreate) | **POST** /api/cloud/floating-ipv6/{id}/rdns/ | 
*CloudApi* | [**cloudFloatingIpv6RdnsRetrieve**](docs/CloudApi.md#cloudfloatingipv6rdnsretrieve) | **GET** /api/cloud/floating-ipv6/{id}/rdns/ | 
