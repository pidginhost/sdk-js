...
|[**cloudFloatingIpv4AuthorizationsRetrieve**](#cloudfloatingipv4authorizationsretrieve) | **GET** /api/cloud/floating-ipv4/{id}/authorizations/ | |
...
|[**cloudFloatingIpv6AuthorizationsRetrieve**](#cloudfloatingipv6authorizationsretrieve) | **GET** /api/cloud/floating-ipv6/{id}/authorizations/ | |
...
# **cloudFloatingIpv4AuthorizationsRetrieve**
> FloatingIPv4 cloudFloatingIpv4AuthorizationsRetrieve()
...
const { status, data } = await apiInstance.cloudFloatingIpv4AuthorizationsRetrieve(
    id
);
```
...
# **cloudFloatingIpv6AuthorizationsRetrieve**
> FloatingIPv6 cloudFloatingIpv6AuthorizationsRetrieve()
...
const { status, data } = await apiInstance.cloudFloatingIpv6AuthorizationsRetrieve(
    id
);
```
...
> AttachIPv4Response cloudServersAttachIpv4Create(attachIPv4)
...
> DetachIPv4Response cloudServersDetachIpv4Create()
