...
**direction** | [**FirewallRuleDirectionEnum**](FirewallRuleDirectionEnum.md) |  | [default to undefined]
**action** | [**FwPolicyOutEnum**](FwPolicyOutEnum.md) |  | [default to undefined]
...
**has_error** | **boolean** |  | [readonly] [default to undefined]
**error_message** | **string** |  | [readonly] [default to undefined]

## Example

```typescript
import { FirewallRule } from '@pidginhost/sdk';

const instance: FirewallRule = {
    id,
    direction,
    action,
    protocol,
